    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (this.showDropdowns) {
                ...
                var monthHtml = '<select class="monthselect form-control input-sm" style="max-width:40%;max-width:50%;">';
                for (var m = 0; m < 12; m++) {
                ...
                var yearHtml = '<select class="yearselect form-control input-sm" style="min-width:50%;max-width:60%;">';
